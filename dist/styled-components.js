...
var validityMethodFor = function validityMethodFor(form) {
  if (typeof form.reportValidity === "function") return function () {
    return form.reportValidity();
  };else if (typeof form.checkValidity === "function") return function () {
...
var reportErrorsForInput = function reportErrorsForInput(input) {
  if (!input.validity || input.validity.valid === true) return [];

  return [input.validationMessage].concat(input.validity.patternMismatch ? "Should match regexp: " + input.pattern : []);
};
...
var App = function (_Component) {
  ...
  _createClass(App, [{
    ...
    key: "onChange",
    value: function onChange(stateKey, e) {
      this.setState(_defineProperty({}, stateKey, {
    ...
    value: function render() {
      ...
      var Input = this.props.inputComponent;
      var idGenerator = function idGenerator(id) {
        return _this2.props.idPrefix + "-" + id;
      };

      return _react2.default.createElement(
        "form",
        { ref: function ref(el) {
            return _this2._formRef = el;
        ...
        _react2.default.createElement("input", { type: "submit", value: "Test Submit" })
      );
    }
  }]);
...
exports.default = function (regexp) {
  return regexp ? regexp.toString().replace(/^\/{1}/, "").replace(/\/[^\/]?$/, "") : undefined;
};
...
*/
var aa=__webpack_require__(2),l=__webpack_require__(9),B=__webpack_require__(3),C=__webpack_require__(1),ba=__webpack_require__(8),da=__webpack_require__(12),ea=__webpack_require__(13),fa=__webpack_require__(10),ia=__webpack_require__(11),D=__webpack_require__(4);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_stylis__ = __webpack_require__(47);
...
/* WEBPACK VAR INJECTION */}.call(__webpack_exports__, __webpack_require__(0), __webpack_require__(48)(module)))
...
exports.renderErrors = exports.Ul = exports.Label = exports.Input = exports.InputWrapper = undefined;
...
var _regexpToPatternAttr = __webpack_require__(17);

var _regexpToPatternAttr2 = _interopRequireDefault(_regexpToPatternAttr);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

function _taggedTemplateLiteral(strings, raw) { return Object.freeze(Object.defineProperties(strings, { raw: { value: Object.freeze(raw) } })); }

var InputWrapper = exports.InputWrapper = _styledComponents2.default.div(_templateObject, function (props) {
  return props.theme.defaultFontFace;
}, function (props) {
  return props.theme.defaultFontSize;
});

var Input = exports.Input = _styledComponents2.default.input(_templateObject2, function (props) {
...
var Label = exports.Label = _styledComponents2.default.label(_templateObject3, function (props) {
  return props.theme.primaryColor;
});

var Ul = exports.Ul = _styledComponents2.default.ul(_templateObject4);

function StyledInput(_ref) {
  ...
  return _react2.default.createElement(
    ...
    _react2.default.createElement(Input, {
      ...
      id: id,
      value: value,
      pattern: (0, _regexpToPatternAttr2.default)(pattern),
      onChange: onChange,
      required: required
    }),
    _react2.default.createElement(
      Label,
      { htmlFor: id, hasError: errors.length > 0 },
      children
    ),
    renderErrors(errors)
  );
...
var renderErrors = exports.renderErrors = function renderErrors(errors) {
...
(0, _reactDom.render)(_react2.default.createElement(
  ...
  { theme: theme },
  _react2.default.createElement(_App2.default, { idPrefix: "styled", inputComponent: _Input2.default })
